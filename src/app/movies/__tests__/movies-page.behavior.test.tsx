...
// Lightweight child mocks
jest.mock('@/features/recommendations/recommended-row', () => () => <div>RecommendedRow</div>)
jest.mock('@/features/rows/genre-row', () => (props: any) => <div>GenreRow {props.title}</div>)
jest.mock('@/features/rows/horizontal-row', () => (props: any) => <div>Row {props.title}</div>)
jest.mock('@/features/search/vertical-results', () => (props: any) => <div>Search: {props.query}</div>)
